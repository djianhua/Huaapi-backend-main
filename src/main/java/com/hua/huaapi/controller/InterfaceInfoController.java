...
import com.hua.huaapi.common.*;
import com.hua.huaapi.constant.CommonConstant;
import com.hua.huaapi.exception.BusinessException;
import com.hua.huaapi.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.hua.huaapi.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.hua.huaapi.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.hua.huaapi.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.hua.huaapi.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        //调用一个验证接口,判断接口能够调用
        com.hua.huaapiclientsdk.model.User user = new com.hua.huaapiclientsdk.model.User();
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Object result = reflectionInterface(HuaapiClient.class, interfaceInfoName, userRequestParams, accessKey, secretKey);
        //网关拦截对异常处理
    ...
    public Object reflectionInterface(Class<?> reflectionClass, String methodName, String parameter, String accessKey, String secretKey) {
        ...
        try {
            ...
            //获取SDK的实例，同时传入密钥
            HuaapiClient huaapiClient = (HuaapiClient) constructor.newInstance(accessKey, secretKey);
            //获取SDK中所有的方法
            Method[] methods = huaapiClient.getClass().getMethods();
            //筛选出调用方法
            for (Method method : methods
                ...
                if (method.getName().equals(methodName)) {
                    ...
                    if (parameterTypes.length == 0){
                        method1 = huaapiClient.getClass().getMethod(methodName);
                        return method1.invoke(huaapiClient);
                    }
                    method1 = huaapiClient.getClass().getMethod(methodName, parameterTypes[0]);
                    //getMethod，多参会考虑重载情况获取方法,前端传来参数是JSON格式转换为String类型
                    //参数Josn化
                    Gson gson = new Gson();
                    Object args = gson.fromJson(parameter, parameterTypes[0]);
                    return result = method1.invoke(huaapiClient, args);
                }
            }
        } catch (Exception e) {
